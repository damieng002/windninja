...
int ninjaArmy::setUpperWind(const int nIndex, const double upper_wind_limit, const double upper_wind_height,
                    const double upper_wind_speed, const double upper_wind_direction, std::string upper_wind_units, const bool upper_wind_zero_middle_layer)
{
    IF_VALID_INDEX_TRY( nIndex, ninjas, ninjas[ nIndex ]->set_upperWind( upper_wind_limit, upper_wind_height, upper_wind_speed, upper_wind_direction, velocityUnits::getUnit( upper_wind_units ), upper_wind_zero_middle_layer));
}
